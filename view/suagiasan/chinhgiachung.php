    ...
    if(isset($_REQUEST["giatri"])){
        ...
        for ($i = 0; $i < sizeof($mangds); $i++) {
            ...
            if($catTTTD[6]=="8"){
                $str .= '
                        ...
                        <fieldset disabled>
                            <div class="form-floating mb-3 border-bottom border-danger border-5 mb-3 pb-2">
        ...
        $str .= '
            <div class="form-floating mb-3">
                ...
                <label for="floatingInput">Giá Mới cho tất cả các thông tin trên (VNĐ)</label>
            </div>
            <button type="submit" name="subTDTTC" class="btn btn-info mb-3">Lưu thông tin</button>
        ';
        echo $str;
    }else{
        echo "";
